...
export const messageMonoNotSupported = "This version supports .NET 11+ (CoreCLR) only. Please target .NET 11+, or install .NET Meteor 6.x if you need Mono runtime support.";
