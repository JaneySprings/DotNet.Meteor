...
public class AndroidEnvStringExtensionTests : TestFixture {
    ...
    [Test]
    public void AndroidEnvExtensionTest10() {
        var env = new Dictionary<string, string> { { "VAR", "123456" }, { "VARIABLE", "VALUE" }, { "VAR2", "12345678910111213141516171819202122232425" }, { "VAR3", "123" } };
        var envString = env.ToAndroidEnvString().Trim('\'');
