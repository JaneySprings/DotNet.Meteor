...
public class AutoConnectionProvider : SoftDebuggerStartArgs, ISoftDebuggerConnectionProvider {
    private TcpClient client = null!;
    private readonly string appName;
    private readonly IPEndPoint endPoint;

    public AutoConnectionProvider(IPAddress host, int port, string appName) {
